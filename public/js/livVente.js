$(document).ready(function() {
    ...
    function afficherRapport() {
        var rapportURL = "http://desktop-46kokp9/ReportServer1/Pages/ReportViewer.aspx?%2fREporting%2fperformanceLiv&rs:Command=Render&rs:embed=true&rc:Toolbar=false";


      

        document.getElementById("rapportLivV").src = rapportURL;
