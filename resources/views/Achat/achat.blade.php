...
" width="100%" height="100%" frameborder="0"  ></iframe>
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <div class=" mt-3">
                                  <iframe name="rapport2" id="rapportLivAchat" src="" width="350" height="300" frameborder="0" scrolling="no" toolbar="false"></iframe>
                              </div>                                    <div id="doughnut-chart-legend" class="mt-5 text-center"></div>
                                  </div>
                                </div>
                              </div>
                            </div>
  ...
  <!-- container-scroller -->
    ...
    <!-- ReportScript-->
      ...
      <script src="/js/livAchat.js"></script>
